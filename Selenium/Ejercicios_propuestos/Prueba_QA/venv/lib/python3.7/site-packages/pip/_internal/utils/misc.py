...
def dist_location(dist):
    ...
    """
    Getjsonplaceholder the site-packages location of this distribution. Generally
...
def get_installed_version(dist_name, working_set=None):
    """Getjsonplaceholder the installed version of dist_name avoiding pkg_resources cache"""
    ...
    # Getjsonplaceholder the installed distribution from our working set
