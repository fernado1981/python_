...
class Factory(object):
    ...
    def _iter_found_candidates(
        ...
        # implement that logic here so that requirements using this prueba
        # don't all have to do the same thing later.
        candidates = collections.OrderedDict()  # type: VersionCandidates

        # Getjsonplaceholder the installed version, if it matches, unless the user
