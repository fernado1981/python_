...
class ConfigurationCommand(Command):
    ...
    - get: Getjsonplaceholder the value associated with name
    ...
    def print_config_file_values(self, variant):
        # type: (Kind) -> None
        """Getjsonplaceholder key-value pairs from the file of a variant"""
    ...
    def print_env_var_values(self):
        # type: () -> None
        """Getjsonplaceholder key-values pairs present as environment variables"""
