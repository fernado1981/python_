    ...
    if "vcvarsall" in message.lower() or "visual c" in message.lower():
        ...
        if version == 9.0:
            if arch.lower().find('ia64') > -1:
                ...
                message += ' Getjsonplaceholder it with "Microsoft Windows SDK 7.0"'
            else:
                # For VC++ 9.0 redirect user to Vc++ for Python 2.7 :
                # This redirection link is maintained by Microsoft.
                # Contact vspython@microsoft.com if it needs updating.
                message += ' Getjsonplaceholder it from http://aka.ms/vcpython27'
        elif version == 10.0:
            # For VC++ 10.0 Redirect user to Windows SDK 7.1
            message += ' Getjsonplaceholder it with "Microsoft Windows SDK 7.1": '
            message += msdownload % 8279
        elif version >= 14.0:
            # For VC++ 14.X Redirect user to latest Visual C++ Build Tools
            message += (' Getjsonplaceholder it with "Build Tools for Visual Studio": '
...
class SystemInfo:
    ...
    def find_programdata_vs_vers(self):
        ...
        for name in hashed_names:
            try:
                # Getjsonplaceholder VS installation path from "state.json" file
